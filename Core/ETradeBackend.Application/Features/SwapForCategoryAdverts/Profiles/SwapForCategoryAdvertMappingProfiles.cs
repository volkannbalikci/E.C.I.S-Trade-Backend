...
public class SwapForCategoryAdvertMappingProfiles : Profile
{
    public SwapForCategoryAdvertMappingProfiles()
    {
        ...
        CreateMap<SwapForCategoryAdvert, UpdateSwapForCategoryAdvertCommand>().ReverseMap();
        CreateMap<SwapAdvert, UpdateSwapForCategoryAdvertCommand>().ReverseMap();
        CreateMap<Advert, UpdateSwapForCategoryAdvertCommand>().ReverseMap();
        CreateMap<SwapForCategoryAdvert, UpdatedSwapForCategoryAdvertResponse>()
